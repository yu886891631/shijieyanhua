 ...
 */
declare function initializeGlobal(global: TypeFest.LiteralUnion<'Mvu' | 'Addon', string>, value: any): void;
 ...
 * ...此后可以直接使用 Mvu 接口
 */
declare function waitGlobalInitialized<T>(global: TypeFest.LiteralUnion<'Mvu' | 'Addon', string>): Promise<T>;
